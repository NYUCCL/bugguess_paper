...
task.  %\hl{why is this overall analysis but the next section also analyzes number of queries per round? GK: it's by query type in future sections..this section is overall (only by cond}
