...
to choose from. Investigating children aged 6-11 years, \citeA{Mosher:1966} 
...
but that do not directly identify the answer (except by elimination). \citeA{Mosher:
1966} identified a developmental trajectory: 6-year-olds tend to do more hypothesis-
...
individual stimuli \cite{Mosher:1966,Ruggeri:2015front}. However, \citeA{Herwig:
1982} found that when items were drawn from basic-level categories (e.g., airplane, 
...
\citeA{Ruggeri:2015front} also found that appropriate cueing can increase the use of 
...
acquiring information change within individuals.
 ...
 %\citeA{Ruggeri:2014} found that younger and older children ask more constraint-
...
clicks_by_age_condition_query_type}
