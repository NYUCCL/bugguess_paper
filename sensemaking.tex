...
\citeA{Mosher:1966} identified two broad question types commonly encountered in the game: \emph{hypothesis-
...
or when not all solutions are equiprobable (e.g.,  \citeA{Ruggeri:2014,Ruggeri:2015}).
...
% this is good but it doesn't belong in "stimuli"  leaving it here for you
%Each of these 
...
%body shape that was not relevant to the bugs on display.\hl{confusing, all the 
%discussion of features seems like a procedure issue?  how is this the stimuli?} The hidden bug was 
...
\begin{figure}[!h]
>>>>>>> lots of stuff up to page 3.  some actionable stuff.  i'll keep going tomorrow morning
  \centering
