...
% rewrite (and expand..maybe move earlier)
...
\hl{full paper: explore click-by-click EIG in a round: is it that automatic participants don't know which feature to click even on the first click, or just that manual subjects ask more contextually-sensitive questions, choosing more informative features after the first click?}
