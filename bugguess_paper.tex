...
However, understanding limitations in children's active inquiry abilities and how each component of such abilities evolves
...
suggests an important nuance of the information processing model summarized in Figure~\ref{fig:sensemaking_loop}.
...
Subjects show showed clear evidence of biased belief updating (e.g., incorrectly interpreting ambiguous 
...
This gave child the possibility to learn the quality of different features across the rounds.
