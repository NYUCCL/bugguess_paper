...
However, there are many reasons to think that these two behaviors might be deeply entwined.
...
\begin{figure}[t] % [!h]
  ...
  \vspace{-.1cm}
  \caption{Proportion of feature vs. exemplar queries by query for each update condition, with a randomly-querying agent for comparison. People in both conditions are more likely to make feature queries rather than 
exemplar queries in the first three queries of a round, but manual-update participants 
move more quickly to exemplar queries, and are overall more likely to make 
exemplar queries. Older children make a higher proportion of feature queries in the first few queries of both conditions.}
...
suggest that the greater mental effort required by manual updating actually led 
